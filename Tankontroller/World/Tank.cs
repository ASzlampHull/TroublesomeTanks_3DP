...
{
    public class Tank : ICollidable, IDeathRingTarget
    {
        ...
        {
            Matrix localTransformation = Matrix.CreateRotationZ(Transform.Rotation) * Matrix.CreateTranslation(new Vector3(Transform.Position.X,Transform.Position.Y,0));
